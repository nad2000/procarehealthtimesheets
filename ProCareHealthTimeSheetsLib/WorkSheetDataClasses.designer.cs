...
namespace SoftwareAssociates.ProCareHealth
{
    ...
    partial void OnCreated();
    partial void OnWeekDay1Changing(byte value);
    partial void OnWeekDay1Changed();
    ...
    partial void OnWeekDayNameChanged();
		...
		public byte WeekDay1
		{
			...
			set
			{
				...
				{
					this.OnWeekDay1Changing(value);
					this.SendPropertyChanging();
					this._WeekDay1 = value;
					this.SendPropertyChanged("WeekDay1");
					this.OnWeekDay1Changed();
				}
			}
		}
    ...
    partial void OnNameChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Company_UserCompany", Storage="_UserCompanies", ThisKey="Id", OtherKey="Companies_Id")]
    ...
    partial void OnCompanies_IdChanging(int value);
    partial void OnCompanies_IdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Companies_Id", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int Companies_Id
		{
			...
			set
			{
				if ((this._Companies_Id != value))
				{
					...
					this.OnCompanies_IdChanging(value);
					this.SendPropertyChanging();
					this._Companies_Id = value;
					this.SendPropertyChanged("Companies_Id");
					this.OnCompanies_IdChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Company_UserCompany", Storage="_Company", ThisKey="Companies_Id", OtherKey="Id", IsForeignKey=true)]
